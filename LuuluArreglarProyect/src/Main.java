...
public class Main {
	...
	public static void main(String[] args) {
		...
		FormularioConfBBDD miFormularioConfBBDD = new FormularioConfBBDD();
		...
		miControlador.setFormularioConfBBDD(miFormularioConfBBDD);
		...
		miFormularioConfBBDD.setControlador(miControlador);
