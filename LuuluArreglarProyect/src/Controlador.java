...
public class Controlador {
	...
	private FormularioConfBBDD miFormularioConfBBDD;
	
	public void setpantallaPrincipal(pantallaPrincipal miPantallaPrincipal) {
		this.miPantallaPrincipal = miPantallaPrincipal;
	}
	public void setFormularioConfBBDD(FormularioConfBBDD FormularioConfBBDD) {
		this.miFormularioConfBBDD = FormularioConfBBDD;
	}
	...
	public void goFormularioConfBBDD() {
		miLogin.setVisible(false);
		miFormularioConfBBDD.setVisible(true);
		
	}
	public void goLoginFormularioConfBBDD() {
		miFormularioConfBBDD.setVisible(false);
		miLogin.setVisible(true);
	}
