...
public class Login extends JFrame {
	...
	private JButton btnConfiguracionBBDD;
	...
	public Login() {
		...
		btnConfiguracionBBDD = new JButton("");
		btnConfiguracionBBDD.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				goFormularioConfBBDD();
			}
		});
		btnConfiguracionBBDD.setIcon(new ImageIcon(Login.class.getResource("/img/Configuracion.png")));
		btnConfiguracionBBDD.setBounds(10, 11, 31, 30);
		getContentPane().add(btnConfiguracionBBDD);
	...
	public void goFormularioConfBBDD() {
		miControlador.goFormularioConfBBDD();
	}
}
